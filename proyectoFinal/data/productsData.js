let vinos = [
    ...
    {
        name:'Angelica Zapata A.',
        type: "Tinto",
        description:'Esta es la primer cosecha de Catena Alta Malbec elaborada mediante el corte de microclimas: Las uvas de este vino, 100% Malbec, provienen de dos viñedos diferentes: el Lote 18 del Viñedo Angélica, de 70 años de edad, con suelo areno/arcilloso, y el Lote 3 del Viñedo Nicasia, de suelo arenoso. En ambos viñedos, la cosecha 2001 se caracterizó por temperaturas promedio levemente más cálidas durante el mes de marzo, con noches muy frescas, y con una amplitud térmica promedio más marcada de lo habitual. En el Viñedo Angélica, esto devino en fruta con intensos sabores de frutos negros y un paladar estructurado, pero suave a la vez, con taninos maduros y dulces. El Malbec del Viñedo Nicasia otorgó delicadas notas florales y dejos especiados de pimienta en el final de boca. Esta cosecha puede beberse y disfrutarse dentro de los próximos 4 a 5 años, continuando su evolución durante 10 años más.',
        variety: "Malbec",
        year: 2001,
